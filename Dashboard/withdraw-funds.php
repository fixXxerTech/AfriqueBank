...
<link rel="icon" href="../images/favicon.ico" type="image/x-icon">
               ...
               <div class="col-md-12 text-center fund-wallet-form">
                  <div>
                     ...
                     <div class="service-box-content">
                        <h3 class="" style="color: #fff;">Investment Withdrawal</h3>
 ...
 ?>
                                 ...
                                 <!-- Input Field Starts -->
                                 <div class="form-group">
                                    <label style="float: left; color: #fff; font:inherit;">Choose withdrawal Option</label>
                                 ...
                                 <!-- Input Field Starts -->
                                 <div class="form-group">
                                    <label style="float: left; color: #fff; font:inherit;">Withdrawal Address/Paypal Wallet</label>
